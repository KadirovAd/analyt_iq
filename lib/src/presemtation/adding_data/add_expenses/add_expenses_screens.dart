...
import 'package:history_trade/src/presemtation/adding_data/profile_formation_screen/profile_formation_screen.dart';
...
class AddExpensesScreens extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<Map<String, dynamic>> categories = [
      {'name': 'Equipment', 'icon': 'assets/icons/category1.png'},
      {'name': 'Software', 'icon': 'assets/icons/category2.png'},
      {
        'name': 'Advertising and marketing',
        'icon': 'assets/icons/category3.png'
      },
      {'name': 'Education and courses', 'icon': 'assets/icons/category4.png'},
      {'name': 'Office expenses', 'icon': 'assets/icons/category5.png'},
      {'name': 'Consumables', 'icon': 'assets/icons/category6.png'},
      {'name': 'Transport', 'icon': 'assets/icons/category7.png'},
      {'name': 'Taxes and insurance', 'icon': 'assets/icons/category8.png'},
      {'name': 'Miscellaneous', 'icon': 'assets/icons/category9.png'},
    ];
